                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="index.php?r=index/upd_pro">
                                <input type="hidden" name="id" value="<?php echo $re['id']?>"/>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">公众账号: <b><?php echo $re['username']?></b></label>

                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">密码</label>
                                    <input type="text"  name="password" value="<?php echo $re['password']?>"
                                           class="form-control"
